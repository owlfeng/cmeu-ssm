                    ...
                    <div class="smart-widget-body no-padding">
                        <div class="padding-md">
                            <div class="canvas-wrapper">
                                <button id="export" type="button" class="btn btn-info">导出txt文件</button>
                                <form action="${pageContext.request.contextPath}/custom/upload" enctype="multipart/form-data" method="post"         上传用户：<input type="text" name="username"><br/>
...
<script type="text/javascript" language="javascript" class="init">
    ...
    $(document).ready(function () {
        ...
        $("#export").click(function () {
            if (confirm("你确定要导出txt文件 ")) {
                window.location.href= "<%=request.getContextPath()%>/custom/export";
            }
        })
